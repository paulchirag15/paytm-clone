...
<body>
    <form class="add_customer_form" action="customer_add_action.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    <option value="delhi">Gandhinagar</option>
                    <option value="newyork">Ahmedabad</option>
                    <option value="paris">Vadodara</option>
                    <option value="riyadh">Surat</option>
                    <option value="moscow">Delhi</option>
                </select>
            </div>
        </div>
